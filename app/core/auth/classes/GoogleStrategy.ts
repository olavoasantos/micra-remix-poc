import {OAuth2Strategy, type OAuth2Profile} from './OAuth2Strategy';
...
export const GoogleStrategyScopeSeparator = ' ';
...
> {
  ...
  protected authorizationParams(): URLSearchParams {
    const params = new URLSearchParams({
      scope: this.scope.join(GoogleStrategyScopeSeparator),
